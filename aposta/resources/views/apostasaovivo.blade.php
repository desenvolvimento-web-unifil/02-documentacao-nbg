...
<body>
    ...
    <div id="betnow">
        Escolha um evento ao vivo e <a href="#">FAÇA SUA APOSTA AGORA!</a>
    </div>

    <div class="container">
        <h1>Apostas ao Vivo</h1>
        <p>Aqui você pode apostar em eventos esportivos em tempo real.</p>
        <p>Confira nossa seleção de eventos ao vivo e faça suas apostas:</p>
        <ul>
            <li>Jogo de Futebol - Time A vs. Time B</li>
            <li>Partida de Tênis - Jogador 1 vs. Jogador 2</li>
            <li>Jogo de Basquete - Time C vs. Time D</li>
            <li>Corrida de Fórmula 1 - Piloto X vs. Piloto Y</li>
        </ul>
    </div>
